...
<p class="codepen" data-height="600" data-theme-id="light" data-default-tab="result" data-user="xugaoyi" data-slug-hash="QWbgLMP" style="height: 600px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="APP是怎样练成的 关于IDE">
  <span>See the Pen <a href="https://codepen.io/xugaoyi/pen/QWbgLMP">
  APP是怎样练成的 关于IDE</a> by xugaoyi (<a href="https://codepen.io/xugaoyi">@xugaoyi</a>)
